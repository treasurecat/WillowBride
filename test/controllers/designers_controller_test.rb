...
class DesignersControllerTest < ActionController::TestCase
  ...
  test "should create designer" do
    assert_difference('Designer.count') do
      post :create, designer: { description: @designer.description, location1: @designer.location1, location2: @designer.location2, location3: @designer.location3, main_image: @designer.main_image, name: @designer.name }
    end
  ...
  test "should update designer" do
    patch :update, id: @designer, designer: { description: @designer.description, location1: @designer.location1, location2: @designer.location2, location3: @designer.location3, main_image: @designer.main_image, name: @designer.name }
    assert_redirected_to designer_path(assigns(:designer))
  end
