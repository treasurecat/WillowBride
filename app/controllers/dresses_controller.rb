class DressesController < ApplicationController
  ...
  # GET /dresses.json
  def index
    @dresses = Dress.order("updated_at DESC").all
  end
  ...
  # GET /dresses/1/edit
  def edit
    @dress_images = DressImage.where("dress_id", @dress.id).order("updated_at DESC")
  end
  ...
  private
    ...
    def dress_params
      params.require(:dress).permit(:designer_id, :location, :main_image, :price, :style, :garment_type, :tag, :name, :collection)
    end
end
